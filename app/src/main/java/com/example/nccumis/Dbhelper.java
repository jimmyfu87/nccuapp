...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    static final String insert_fake_expense=
            "INSERT INTO " + "Expense" + " (Ex_price,Ex_date,Type_name,Book_name,Ex_note) VALUES"
                    + "(500,'2019-08-01','投資','現金帳本','買東西'),(1000,'2019-08-02','交通','購物帳本','買東西')," +
                    "(300,'2019-08-03','早餐','現金帳本','買東西'),(500,'2019-08-06','投資','現金帳本','買東西')," +
                    "(600,'2019-08-08','衣物','旅遊帳本','買東西'),(3200,'2019-08-10','娛樂','現金帳本','買東西')," +
                    "(300,'2019-08-13','電話費','現金帳本','買東西'),(500,'2019-08-16','投資','購物帳本','買東西')," +
                    "(300,'2019-08-17','零食','現金帳本','買東西'),(600,'2019-08-20','早餐','現金帳本','買東西')," +
                    "(500,'2019-08-23','早餐','現金帳本','買東西'),(700,'2019-08-28','投資','旅遊帳本','買東西');";

    static final String insert_fake_income=
            "INSERT INTO " + "Income" + " (In_price,In_date,Type_name,Book_name,In_note) VALUES"
                    + "(5000,'2019-08-01','投資','現金帳本','股利'),(22000,'2019-08-02','薪水','現金帳本','公司薪水')," +
                    "(300,'2019-08-03','樂透中獎','現金帳本','運彩'),(3000,'2019-08-06','投資','現金帳本','基金')," +
                    "(600,'2019-08-08','樂透中獎','現金帳本','大樂透'),(2000,'2019-08-10','薪水','現金帳本','加班費')," +
                    "(300,'2019-08-13','樂透中獎','現金帳本','運彩'),(500,'2019-08-16','其他','購物帳本','購物禮卷')," +
                    "(300,'2019-08-17','樂透中獎','旅遊帳本','刮刮樂'),(200,'2019-08-20','發票中獎','現金帳本','4月發票');" ;
