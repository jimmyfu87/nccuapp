...
public class Dbhelper extends SQLiteOpenHelper {
    ...
    static final String insert_default_book=
            "INSERT INTO " + "Book" + " (Book_name,Amount_start,Amount_remain,Currency_type,Start_date,End_date,Closed) VALUES"
                    + "('現金帳本',900,0,'TWD','2019-04-20','2019-12-31',0)"+ ",('旅遊帳本',6000,0,'TWD','2019-07-01','2019-10-12',0)"+",('購物帳本',3000,0,'TWD','2018-03-31','2019-10-31',0);";
    ...
    static final String insert_fake_income=
            "INSERT INTO " + "Income" + " (In_price,In_date,Type_name,Book_name,In_note) VALUES"
                    + "(5000,'2019-10-01','投資','現金帳本','股利'),(22000,'2019-10-02','薪水','現金帳本','公司薪水')," +
                    "(300,'2019-10-03','樂透中獎','現金帳本','運彩'),(3000,'2019-10-06','投資','現金帳本','基金')," +
                    "(600,'2019-10-08','樂透中獎','現金帳本','大樂透'),(2000,'2019-10-10','薪水','現金帳本','加班費')," +
                    "(300,'2019-10-13','樂透中獎','現金帳本','運彩'),(500,'2019-10-16','其他','購物帳本','購物禮卷')," +
                    "(300,'2019-10-17','樂透中獎','旅遊帳本','刮刮樂'),(200,'2019-10-20','發票中獎','現金帳本','4月發票');" ;
